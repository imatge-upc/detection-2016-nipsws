...
def draw_sequences(i, k, step, action, draw, font, region_image, background, path_testing_folder, iou, reward,
...
def draw_sequences_test(step, action, qval, draw, font, region_image, background, path_testing_folder,
